...
function sidebar() {
  ...
  return (
    ...
    <div className="space-y-2.5 mt-4 mb-2.5 xl:ml-24">
        <SidebarLink text="Homes" Icon={AiFillHome} active />
    ...
    <button className="xl:inline ml-auto  rounded-full w-56 h-[52px] 
    text-lg font-bold shadow-md  text-white" >
     <div className="text-[#d9d9d9] flex items-center justify-center
    hoverAnimation xl:ml-auto xl:mr-2.5 mt-auto" onClick={signOut}>
      <img src={session.user.image} alt=""
      className="w-10 h-10 rounded-full xl:mr-2.5"
      />
    <div className="hidden xl:inline leading-5">
      <h4 className="fond-bold text-white">{session.user.name}</h4>
